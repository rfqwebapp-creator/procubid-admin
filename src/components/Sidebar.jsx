...
const Sidebar = () => {
  return (
    <div className="w-60 bg-primary text-white min-h-screen flex flex-col px-5 py-6">
      ...
      <nav className="flex flex-col gap-1">
        ...
        <NavLink to="/" className={({isActive}) =>
          ...
          ${isActive ? "bg-secondary text-dark font-medium" : "hover:bg-secondary hover:text-dark"}`
        }>
          <FiGrid size={18}/>
          Dashboard
        </NavLink>
        ...
        <NavLink to="/tenders" className={({isActive}) =>
          `flex items-center gap-3 px-3 py-2 rounded-lg transition
          ${isActive ? "bg-secondary text-dark font-medium" : "hover:bg-secondary hover:text-dark"}`
        }>
          <FiFileText size={18}/>
      ...
      <nav className="flex flex-col gap-1">
        ...
        <NavLink to="/audit-logs" className={({isActive}) =>
          `flex items-center gap-3 px-3 py-2 rounded-lg transition
          ${isActive ? "bg-secondary text-dark font-medium" : "hover:bg-secondary hover:text-dark"}`
        }>
          <FiShield size={18}/>
