  ...
  return (
    <div className="space-y-6">
      ...
      {activeTab === "subscription" && (
        <>
          {loadingPlans ? (
            <div className="bg-white rounded-xl p-6 shadow-sm border text-gray-500">
              Loading plans...
            </div>
          ) : (
            <>
                              ...
                              >
                                <div
                                  className={`bg-white w-4 h-4 rounded-full shadow-md transform duration-300 ${
                                    Number(plan.enabled) === 1 ? "translate-x-6" : ""
                                  }`}
                                />
                              </div>
                            </td>
      ...
      {showCommissionModal && (
        <AddCommissionModal close={() => setShowCommissionModal(false)} />
      )}
      ...
      {showReferralModal && (
        <GenerateReferralModal close={() => setShowReferralModal(false)} />
      )}
