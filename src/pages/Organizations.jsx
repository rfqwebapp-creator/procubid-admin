  ...
  return (
    <div>
      ...
      <div className="flex justify-between items-center mb-6">
        ...
        <button className="bg-secondary text-dark px-4 py-2 rounded-lg font-medium hover:opacity-90 transition">
          + Add Organization
        </button>
          ...
          <tbody>
            {filteredOrganizations.map((org, index) => (
              <tr key={index} className="border-t hover:bg-gray-50 transition">
                ...
                <td className="p-4 text-gray-500">{org.email}</td>
                <td className="p-4">
                ...
                <td className="p-4">{org.region}</td>
                <td className="p-4">
